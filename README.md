...
| `URL`          | URL langsung ke halaman buku        |
...
- **Optimasi function `scrape_halaman()`**: Menggunakan BeautifulSoup object yang sudah di-parse untuk menghindari duplikasi HTTP request
- **Penambahan URL Buku**: Setiap buku sekarang memiliki URL langsung ke halamannya
- **Better logging**: Menampilkan jumlah buku yang ditemukan di setiap halaman
- **Improved error handling**: Penanganan error yang lebih robust
